...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2017 at 10:24 AM
...
('Test', 'System(All Projects)', 'Default Schedule', 'Test.', '2017-02-16', '2017-04-13', 'WMLcSbOlTD9M+JAgQu2fu112+IG3X7DnZzsqc/b9dG0=', '', 0, 0, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `scrum_project_member` (
  ...
  PRIMARY KEY (`project_title`,`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('Project 2017', '01+O14EZgMXS3toX8BZa7J8XMNOyu4C40/hqxFDYNlc=', 'team member'),
('Project 2017', 'WMLcSbOlTD9M+JAgQu2fu112+IG3X7DnZzsqc/b9dG0=', 'team member'),
('Project 2017', 'rF2DBIUAwwuxssPP+F3jxSkJAbXsoFRIZOMUeGQHo9A=', 'team member'),
('Project 2017', 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'system admin'),
('Test', 'WMLcSbOlTD9M+JAgQu2fu112+IG3X7DnZzsqc/b9dG0=', 'system admin');
...
(6153571, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'PASS TO CORRESPONDING GROUP', '', 2016, 'P10,P20,P30', 'P-10-42', '2016-10-16'),
...
(6220475, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'NONE', '', 2017, 'P20,P30', 'P-20-75', '2017-02-17'),
...
(6367392, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'ON HOLD', '', 2017, 'P10,P20,P30', 'P-10-42', '2017-02-02'),
