...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 03, 2017 at 06:04 AM
...
--
-- Table structure for table `scrum_defect`
--

CREATE TABLE IF NOT EXISTS `scrum_defect` (
  `title` varchar(50) NOT NULL,
  `project` varchar(50) NOT NULL,
  `sprint` varchar(50) NOT NULL,
  `team` int(11) NOT NULL,
...
('New Project', 'System(All Projects)', 'Default Schedule', 'New Project', '2017-01-03', '2017-03-15', 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', '', 0, 0, 0, NULL),
('Project 2017', 'System(All Projects)', 'Default Schedule', 'Project 2017', '2017-01-02', '2017-12-29', 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', '', 0, 0, 0, NULL),
('Release 1.0', 'Project 2017', 'Default Schedule', 'Release 1.0', '2017-01-02', '2017-06-30', 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', '', 0, 0, 0, NULL),
('System(All Projects)', 'System(All Projects)', 'Default Schedule', 'System(All Projects)', '0000-00-00', '0000-00-00', 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', '', 0, 0, 0, NULL);
...
INSERT INTO `scrum_project_member` (`id`, `project_title`, `member_id`, `privilage`) VALUES
(1, 'Project 2017', 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'system admin'),
(2, 'Project 2017', 'WMLcSbOlTD9M+JAgQu2fu112+IG3X7DnZzsqc/b9dG0=', 'none'),
(3, 'Project 2017', 'WMLcSbOlTD9M+JAgQu2fu112+IG3X7DnZzsqc/b9dG0=', 'team member'),
(5, 'Project 2017', '01+O14EZgMXS3toX8BZa7J8XMNOyu4C40/hqxFDYNlc=', 'team member');

-- --------------------------------------------------------

--
-- Table structure for table `scrum_release_planning`
--

CREATE TABLE IF NOT EXISTS `scrum_release_planning` (
  ...
  `target_swag` double NOT NULL,
  `target_estimate` double NOT NULL,
  `test_suit` int(11) NOT NULL,
...
('Project(2017) Sprint Schedule', 1, 'months', 2, 'days', 'Project(2017) Sprint Schedule.\n');
...
(6143700, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'INVESTIGATING', '', 2016, 'P20,P30', 'P-20-74', '2016-10-09'),
(6153571, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'NONE', '', 2016, 'P10,P20,P30', 'P-10-42', '2016-10-16'),
(6197350, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'NONE', '', 2017, 'P10,P20,P30', 'P-10-42', '2016-11-06'),
(6207181, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'PASS FOR TESTING', '', 2017, 'P10,P20,P30', '', '2016-11-19'),
(6218263, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'NONE', '6218263', 2017, 'P10,P20,P30', '', '2017-01-23'),
(6220677, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'PASS FOR TESTING', '', 2017, 'P10,P20,P30', '', '2016-11-25'),
...
(6258104, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'NONE', '', 2017, 'P10,P20,P30', '', '2016-12-21'),
(6367392, 'xDK1A19VIXHFSXK2lSl30H/R5AM31+wwkIi0pa1Kz/c=', 'INTEGRITY SPR', 'NONE', '', 2017, 'P10,P20,P30', 'P-10-42', '2017-02-02'),
...
('01+O14EZgMXS3toX8BZa7J8XMNOyu4C40/hqxFDYNlc=', 'k5dyEgKS4Ik8jdJvgYn3LsSdCqUShPfpNgaChUE0iYE=', 'BgD0WWyNmc2/1MiLtL+rHZ7Rok23zhPbELGfCPilQOg=', 'KcdInh7PFN8iFSuqwtAV5cBYM8VXgYJvkNd8Jbh9O9Y=', 'Male', '1b6IlJ4aKdThBkd9V9l9AP3CVuC5/pXHgj10wutzeVE=', 'hDJbEDyRcywkMYy6up4Cvv2m/zS7m9008XxCV1kuKww=', 'none', 'zxApBNrIloozd6QiLpEbnhN+blGm4rQDYl4fVcGj9wk=', '', 'Jqi+Elq9XHX7rAjE5Fl7H1fcqrNjFPn4eNYWmC0sQsc='),
