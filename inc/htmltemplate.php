...
class HomeHTML extends HTMLTemplate
{
    ...
    {
    $tag = '<div style="width:400px; height:400px;"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 593.9 593.9" enable-background="new 0 0 593.9 593.9" xml:space="preserve">
<g id="Layer_8">
    <g id="Layer_1">
    <g id="Layer_2">
    </g>
...
<g id="Layer_5">
    ...
    /*<g id="XMLID_24_">
    <g id="XMLID_26_">
    <linearGradient id="XMLID_470_" gradientUnits="userSpaceOnUse" x1="302.8209" y1="262.2209" x2="302.8209" y2="289.1411">
    <stop offset="0" style="stop-color:#FFFFFF"></stop>
    <stop offset="0.9944" style="stop-color:#000000"></stop>
    </linearGradient>
    <path id="XMLID_27_" fill="url(#XMLID_470_)" d="M301.1,270.1h-4l4.9-8.1h13.6l-15.9,26.4h-9.6L301.1,270.1z"></path>
    </g>
    <path id="XMLID_25_" fill="#802245" d="M299.7,288.4c-3.2,0-6.4,0-9.6,0c2.6-5.1,1-12.3-3.6-18.6c-1.3,0-2.7,0-4,0
    c-2.1-2.8-4.7-5.5-7.9-7.8c4.5,0,9.1,0,13.6,0C298.4,269.4,303.5,280.9,299.7,288.4z"></path>
    </g>*/
$tag .='</g>
</svg></div>';
