...
class ScrumPPBHTML extends HTMLTemplate
{
    ...
    protected function addDashboard()
    {
        ...
        $tag = ' <div class="article-container">';
        $tag = ' <div class="project-backlog-container">';
        $tag = ' <div id="move-to-project-btn" class="quick-action-btn move-to-project-btn">';
        $tag = ' <a class="quick-action-text" href="popup:WidgetsDetails/QuickEditStory">Move to Project</a>';
        $tag = ' <a id="quick-action-arrow" class="quick-action-arrow" onclick="showHideEditMenu('show', 'move-to-project-btn', 'move-to-project-dropdown')" onblur="showHideEditMenu('hide', 'move-to-project-btn', 'move-to-project-dropdown')">';
        $tag = ' <span>';
        $tag = ' <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">';
        $tag = ' <g>';
        ...
        $tag = ' </a>';
        $tag = ' </div>';
        $tag = ' <div id="move-to-project-dropdown" class="dropdown-content">';
        $tag = ' <a href="#">Move To Project</a>';
        $tag = ' <a href="#">Move To Iteration</a>';
        $tag = ' <a href="#">Quick Close</a>';
        $tag = ' <a href="#">Close</a>';
        $tag = ' <a href="#">Reopen</a>';
        $tag = ' <a href="#">Delete</a>';
        $tag = ' <a href="#">Rank</a>';
        $tag = ' </div>';
        $tag = ' <div id="backlog-table-dropdown" class="dropdown-content">';
        $tag = ' <a class="dashed-bottom-border" href="#">Edit</a>';
        $tag = ' <a href="#">Plan Story</a>';
        $tag = ' <a href="#">Add Task</a>';
        $tag = ' <a class="dashed-bottom-border" href="#">Copy</a>';
        $tag = ' <a href="#">Quick Close</a>';
        $tag = ' <a class="dashed-bottom-border" href="#">Close</a>';
        $tag = ' <a href="#">Convert to Defect</a>';
        $tag = ' <a href="#">Delete</a>';
        $tag = ' </div>';
        $tag = ' <div class="project-backlog-table-container">';
        $tag = ' <table id="project-backlog-table" class="grippy-table">';
        $tag = ' <thead id="project-backlog-thead">';
        $tag = ' <tr>';
        $tag = ' <th> </th>';
        $tag = ' <th style="text-align: center;">';
        $tag = ' <input id="_fjvevqi" _v1_multiselector="1" type="checkbox" clickhandler="V1.Gadgets.Grid.MultiSelect.ToggleAll('_fjvevqi');" name="selectAll">';
        $tag = ' </th>';
        $tag = ' <th data-sort="int">Order</th>';
        $tag = ' <th data-sort="string"><a class="sortable">Title</a></th>';
        $tag = ' <th data-sort="string"><a class="sortable">ID</a></th>';
        $tag = ' <th data-sort="string"><a class="sortable">Owner</a></th>';
        $tag = ' <th data-sort="string"><a class="sortable">Priority</a></th>';
        $tag = ' <th data-sort="string"><a class="sortable">Estimate Pts</a></th>';
        $tag = ' <th data-sort="string"><a class="sortable">Project</a></th>';
        $tag = ' <th> </th>';
        $tag = ' </tr>';
        $tag = ' </thead>';
        $tag = ' <tbody id="project-backlog-tbody">';
        $tag = ' <tr align="center">';
        $tag = ' <td class="hasGrippy" style="text-align: center;">';
        $tag = ' <i class="grippy">';
        $tag = ' <i class="dot"></i>';
        $tag = ' <i class="dot"></i>';
        $tag = ' <i class="dot"></i>';
        ...
        $tag = ' <input _v1_multiselector="1" type="checkbox" clickhandler="V1.Gadgets.Grid.MultiSelect.ToggleAll('_fjvevqi');" name="selectAll">';
        $tag = ' </td>';
        $tag = ' <td>1</td>';
        $tag = ' <td>';
        $tag = ' <div class="backlog-title-container">';
        $tag = ' <span class="backlog-image-container">';
        $tag = ' <img alt="12345" src="../../images/Defect-Icon.gif" title="12345">';
        $tag = ' </span>';
        $tag = ' <a>6534211</a>';
        $tag = ' </div>';
        $tag = ' </td>';
        ...
        $tag = ' <td>High</td>';
        $tag = ' <td>15.0</td>';
        $tag = ' <td>Release 1.0</td>';
        $tag = ' <td class="gg" align="right" style="text-align: right;">';
        $tag = ' <div id="backlog-table-btn-1" class="quick-action-btn backlog-table-btn">';
        $tag = ' <a class="quick-action-text" href="popup:Widgets/Details/QuickEditStory">Edit</a>';
        $tag = ' <a id="quick-action-arrow" class="quick-action-arrow" onclick="showHideEditMenu('show', 'backlog-table-btn-1', 'backlog-table-dropdown')" onblur="showHideEditMenu('hide', 'backlog-table-btn-1', 'backlog-table-dropdown')">';
        $tag = ' <span>';
        $tag = ' <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">';
        $tag = ' <g>';
        $tag = ' <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751 c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0 c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>';
        ...
        $tag = ' <td>Release 1.0</td>';
        $tag = ' <td class="gg" align="right" style="text-align: right;">';
        $tag = ' <div id="backlog-table-btn-2" class="quick-action-btn backlog-table-btn">';
        $tag = ' <a class="quick-action-text" href="popup:Widgets/Details/QuickEditStory">Edit</a>';
        $tag = ' <a id="quick-action-arrow" class="quick-action-arrow" onclick="showHideEditMenu('show', 'backlog-table-btn-2', 'backlog-table-dropdown')" onblur="showHideEditMenu('hide', 'backlog-table-btn-2', 'backlog-table-dropdown')">';
        $tag = ' <span>';
        $tag = ' <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">';
        $tag = ' <g>';
        $tag = ' <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751 c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0 c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>';
        ...
        $tag = ' <td>Release 1.0</td>';
        $tag = ' <td class="gg" align="right" style="text-align: right;">';
        $tag = ' <div id="backlog-table-btn-3" class="quick-action-btn backlog-table-btn">';
        $tag = ' <a class="quick-action-text" href="popup:Widgets/Details/QuickEditStory">Edit</a>';
        $tag = ' <a id="quick-action-arrow" class="quick-action-arrow" onclick="showHideEditMenu('show', 'backlog-table-btn-3', 'backlog-table-dropdown')" onblur="showHideEditMenu('hide', 'backlog-table-btn-3', 'backlog-table-dropdown')">';
        $tag = ' <span>';
        $tag = ' <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">';
        $tag = ' <g>';
        $tag = ' <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751 c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0 c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>';
        ...
        $tag = ' <td>Release 1.0</td>';
        $tag = ' <td class="gg" align="right" style="text-align: right;">';
        $tag = ' <div id="backlog-table-btn-4" class="quick-action-btn backlog-table-btn">';
        $tag = ' <a class="quick-action-text" href="popup:Widgets/Details/QuickEditStory">Edit</a>';
        $tag = ' <a id="quick-action-arrow" class="quick-action-arrow" onclick="showHideEditMenu('show', 'backlog-table-btn-4', 'backlog-table-dropdown')" onblur="showHideEditMenu('hide', 'backlog-table-btn-4', 'backlog-table-dropdown')">';
        $tag = ' <span>';
        $tag = ' <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">';
        $tag = ' <g>';
        $tag = ' <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751 c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0 c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>';
        ...
        $tag = ' <td>Release 1.0</td>';
        $tag = ' <td class="gg" align="right" style="text-align: right;">';
        $tag = ' <div id="backlog-table-btn-5" class="quick-action-btn backlog-table-btn">';
        $tag = ' <a class="quick-action-text" href="popup:Widgets/Details/QuickEditStory">Edit</a>';
        $tag = ' <a id="quick-action-arrow" class="quick-action-arrow" onclick="showHideEditMenu('show', 'backlog-table-btn-5', 'backlog-table-dropdown')" onblur="showHideEditMenu('hide', 'backlog-table-btn-5', 'backlog-table-dropdown')">';
        $tag = ' <span>';
        $tag = ' <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">';
        $tag = ' <g>';
        $tag = ' <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751 c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0 c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>';
        ...
        $tag = ' <td>Release 1.0</td>';
        $tag = ' <td class="gg" align="right" style="text-align: right;">';
        $tag = ' <div id="backlog-table-btn-6" class="quick-action-btn backlog-table-btn">';
        $tag = ' <a class="quick-action-text" href="popup:Widgets/Details/QuickEditStory">Edit</a>';
        ...
        $tag = ' <div class="backlog-title-container">';
        $tag = ' <span class="backlog-image-container">';
        $tag = ' <img alt="12345" src="../../images/Feature-Icon.gif" title="12345">';
        $tag = ' </span>';
        $tag = ' <a>Scrum Web-page Design</a>';
        $tag = ' </div>';
        $tag = ' </td>';
        $tag = ' <td>s00007</td>';
        $tag = ' <td>Abhishek</td>';
        ...
        $tag = ' <td>Release 1.0</td>';
        $tag = ' <td class="gg" align="right" style="text-align: right;">';
        $tag = ' <div id="backlog-table-btn-7" class="quick-action-btn backlog-table-btn">';
        $tag = ' <a class="quick-action-text" href="popup:Widgets/Details/QuickEditStory">Edit</a>';
        $tag = ' <a id="quick-action-arrow" class="quick-action-arrow" onclick="showHideEditMenu('show', 'backlog-table-btn-7', 'backlog-table-dropdown')" onblur="showHideEditMenu('hide', 'backlog-table-btn-7', 'backlog-table-dropdown')">';
        $tag = ' <span>';
        $tag = ' <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">';
        $tag = ' <g>';
        $tag = ' <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751 c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0 c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>';
